...
_lr_productions = [
  ...
  ('expression -> LBRACE int_type_array RBRACE','expression',3,'p_expression_array','analyze.py',268),
  ('expression -> LBRACE float_type_array RBRACE','expression',3,'p_expression_array','analyze.py',269),
  ('expression -> LBRACE string_type_array RBRACE','expression',3,'p_expression_array','analyze.py',270),
  ('expression -> LBRACE bool_type_array RBRACE','expression',3,'p_expression_array','analyze.py',271),
  ('int_type_array -> empty','int_type_array',1,'p_int_type_array','analyze.py',278),
  ('int_type_array -> INT int_type_array','int_type_array',2,'p_int_type_array','analyze.py',279),
  ('float_type_array -> empty','float_type_array',1,'p_float_type_array','analyze.py',292),
  ('float_type_array -> FLOAT float_type_array','float_type_array',2,'p_float_type_array','analyze.py',293),
  ('string_type_array -> empty','string_type_array',1,'p_string_type_array','analyze.py',306),
  ('string_type_array -> STRING string_type_array','string_type_array',2,'p_string_type_array','analyze.py',307),
  ('bool_type_array -> empty','bool_type_array',1,'p_bool_type_array','analyze.py',320),
  ('bool_type_array -> TRUE bool_type_array','bool_type_array',2,'p_bool_type_array','analyze.py',321),
  ('bool_type_array -> FALSE bool_type_array','bool_type_array',2,'p_bool_type_array','analyze.py',322),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_parenthesis','analyze.py',337),
  ('conditional -> IF expression START NEWLINE language STOP else_if_blocks else_block','conditional',8,'p_conditional','analyze.py',346),
  ('else_if_blocks -> empty','else_if_blocks',1,'p_else_if_blocks','analyze.py',355),
  ('else_if_blocks -> else_if_blocks else_if_block','else_if_blocks',2,'p_else_if_blocks','analyze.py',356),
  ('else_if_block -> ELSE_IF expression START NEWLINE language STOP','else_if_block',6,'p_else_if_block','analyze.py',371),
  ('else_block -> ELSE START NEWLINE language STOP','else_block',5,'p_else_block','analyze.py',380),
  ('else_block -> empty','else_block',1,'p_else_block','analyze.py',381),
  ('iterative -> WHILE expression START NEWLINE language STOP','iterative',6,'p_iterative','analyze.py',394),
  ('empty -> <empty>','empty',0,'p_empty','analyze.py',460),
]
